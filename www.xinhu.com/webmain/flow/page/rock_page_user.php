...
$(document).ready(function(){
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'用户('+nowtabs.name+')',
				cont:'用户('+nowtabs.name+')的列表的',
				explain:'订阅[用户]的列表',
				objtable:a
			});
		},

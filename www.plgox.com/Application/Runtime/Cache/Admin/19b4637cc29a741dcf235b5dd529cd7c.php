...
<div class="table-responsive">
	...
	<?php if(is_array($order_detil)): $i = 0; $__LIST__ = $order_detil;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order_): $mod = ($i % 2 );++$i;?><tr class="table_tr_<?php echo ($order_['order_id']); ?>">
			...
			<td style="text-align: center;line-height:50px;"><img src="/Uploads/admin/<?php echo ($order_['specifications_img']); ?>" style="width:50px;height:50px;"></td>
			...
			<td style="text-align: center;line-height:50px;color:red">¥<?php echo ($order_['order_mm_prices']); ?></td>
			<td style="text-align: center;line-height:50px;">
			...
			<!-- 商品状态 -->
			<?php if(($order_['order_status']) == 0 ): ?><td style="text-align: center;line-height:50px;"><font color="red">等待买家付款</font></td>
			...
			<?php elseif(($order_['order_status']) == 11): ?>
				<td style="text-align: center;line-height:50px;"><font color="red">交易关闭</font></td><?php endif; ?>
			<!-- 支付状态 -->
			...
			<td style="text-align: center;line-height:50px;">
				<a href="<?php echo U('Orderdetails/order_details_shop_data');?>&order_id=<?php echo base64_encode($order_['order_id'])?>" title="订单查看" class="">查看详情</a>&nbsp;&nbsp;

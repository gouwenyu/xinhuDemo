   ...
   <div class="mypj1">
     ...
     <div class="mypj1_box">
          ...
          <div class="shfw3" style="margin-top:15px;">
	            	<div class="shfw31">1、魄力餐厨作为首家餐饮酒店设备租赁平台，正在飞速发展，我们一路也获得投资人、用户、供应商的认可，我们的成长和突破都是对他们的认可最好的回报；</div>
	            	<div class="shfw31">2、如果您对我们有任何合作想法我们都非常期待跟您去合作</div>
	            	<div class="shfw31">3、network@plgox.com</div>
...
var arra1=new Array(".help_zl",".help_sh",".help_sm",".help_wt");
var arra2=new Array(1,2,3,4);
gbys(arra1,arra2,'100px',2);
</script>
</br>

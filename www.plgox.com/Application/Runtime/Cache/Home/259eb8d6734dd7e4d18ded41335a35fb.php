...
<div class="mypj">
   ...
   <div  class="mypj2">
            ...
            <div class="shfw3" style="margin-top:15px;">
	            	<div class="shfw31">满足以下情况之一的，该承租方将被认定为失信客户：</div>
	            	<div class="shfw31">1、逾期15个自然日不支付设备租金；</div>
	            	<div class="shfw31">2、按约定应当归还设备，但拒不归还；</div>
	            	<div class="shfw31">3、部分产品在租期结束前提前归还设备，但不按协议支付随租随还服务费或违约金；</div>
	            	<div class="shfw31">4、归还的设备严重损坏，但拒不按协议偿付维修费用。</div>
	           </div>
              <div class="shfw3">
	            	<div class="shfw31">对于被认定为失信客户的，租街将有权利采取包括但不限于以下的措施：</div>
	            	<div class="shfw31">1、不接受失信客户的服务需求；</div>
	            	<div class="shfw31">2、将失信客户公司信息及相应的申请人个人信息在魄力餐厨公布；</div>
	            	<div class="shfw31">3、将失信客户公司信息及相应的申请人个人信息在互联网其他网站公布；</div>
	            	<div class="shfw31">4、将失信客户公司信息及相应的申请人个人信息提供给第三方机构，包括央行下属征信平台、芝麻信用等征信机构；</div>
	            	<div class="shfw31">5、向公安机关报案；</div>
	            	<div class="shfw31">6、向法院起诉，并依照相关法律规定，报请将失信客户的身份信息及相关公司信息至中国人民共和国全国法院被执行人信息网公布。</div>
	            </div>
	            <div class="shfw3" style="padding-bottom:0px;">
	            	<div class="shfw31">因魄力餐厨对失信客户采取的任何措施给失信客户带来的任何损失，均由该承租方自行承担，租街概不负责。</div>
	            	<div class="shfw31">对于任何无法按合约履行的情况，欢迎双方友好协商解决，尽量避免发生信用违约，请致电 010-67881490。</div>
...
var arra1=new Array(".help_zl",".help_wm",".help_sm",".help_wt");
var arra2=new Array(0,1,2,4);
gbys(arra1,arra2,'350px',19);

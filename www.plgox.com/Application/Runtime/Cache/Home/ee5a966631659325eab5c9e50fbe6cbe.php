   ...
   <div class="mypj1">
     ...
     <div class="mypj1_box">
           ...
           <div class="shfw3" style="margin-top:15px;">
	            	<div class="shfw31">1、全新设备的维修费用由厂家售后服务站出具故障现象、故障成因、维修费用的工单作为维修费的凭证；魄力餐厨客服人员受理您的信息后，会协助代报修原厂。</div>
	            	<div class="shfw31">2、 保内的非全新设备由厂家售后服务站出具故障现象、故障成因、维修费用的工单作为维修费的凭证；魄力餐厨客服人员受理您的信息后，会协助代报修原厂。</div>
	            	<div class="shfw31">3、 脱保的非全新设备由魄力餐厨维修服务部出具故障现象、故障成因、维修费用的工单作为维修费的凭证；魄力餐厨客服人员受理您的信息后，会指导您将设备寄回或收回魄力餐厨进行维修相关事宜，为了不耽误您的使用，魄力餐厨可以同步为您进行换机处理。魄力餐厨收到机器后会进行检测，根据检测结果与您沟通维修费用事宜。</div>
...
var arra1=new Array(".help_sh",".help_wm",".help_zl",".help_sm");
var arra2=new Array(0,1,2,3);
gbys(arra1,arra2,'250px',22);

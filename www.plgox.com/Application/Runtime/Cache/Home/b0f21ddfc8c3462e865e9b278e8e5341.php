  	...
  	$(".es_detil_left_img img").each(function(){
  		...
  		<div class="es_detil_mi">
  			...
  			<div class="es_detil_mi3">
  			   <div class="es_detil_tk"> 
                 <span class="es_detil_jg"> 价格：</span>
                 <span class="es_detil_jg_1">¥<?php echo ($goods_detail["goods_deal_price"]); ?></span>
               </div>
               <div class="es_detil_tk"> 
                 <span class="es_detil_jg1"> 市场价格：</span>
                 <span class="es_detil_jg1_1">¥<?php echo ($goods_detail["goods_cost_price"]); ?></span>
               </div>
                 <?php if($goods_detail["goods_is_business"] == 1): ?><span class="es_detil_q">企</span><?php endif; ?>	
                 <?php if($goods_detail["goods_is_batch"] == 1): ?><span class="es_detil_mi32">量</span><?php endif; ?>	
  			</div>
  			<div style="clear:both;"></div>
  			<div class="es_detil_mi99">
	  			<div class="es_detil_mi6">
	                                    品牌：<?php echo ($goods_detail["goods_brand"]); ?>
	  			</div>
	  			<div class="es_detil_mi6">
	                                产地：<?php echo ($goods_detail["goods_produce_address"]); ?>
	  			</div>
	  			<!--<div class="es_detil_mi6">
	                                交易地点：<?php echo ($goods_detail["goods_province"]); ?>&nbsp;&nbsp; <?php echo ($goods_detail["goods_city"]); ?>
	  			</div>-->
  			</div>
          ...
          <?php if(( $wyyx_id['wyyx_status'] == 1 ) OR ( $wyyx_id['wyyx_status'] != null )): ?><span class="es_detil_mi71">查看卖家联系方式</span><?php endif; ?>
  				<!-- <?php if($goods_detail["is_collect"] == 0): ?><img class="es_detil_mi72" src="/Public/Home/image/esxz_detil_sc.jpg" />
  				<?php else: ?>
  				<img class="es_detil_mi72" src="/Public/Home/image/esxz_detil_dj.jpg" /><?php endif; ?>
...
<!--查看买家联系方式-->	
	<div class="zz_nr" style="display:none;height:400px;">
	  <div class="zz_nr1">
...
<!--查看买家联系方式--> 
   <div class="zz_nr_bjzd2" style="display:none;height:460px;">
    ...
    <div class="esxz_de_zz1" >
      友情提示：为了方便您查看卖家联系方式，顺利完成交易，请填写完整信息！
    </div>
    <br/>
    <div class="esxz_de_zz2" >
      <div>报价：</div>
...
$(".es_detil_mi72").click(function(){
	...
	if($(this).attr('src')=='/Public/Home/image/esxz_detil_dj.jpg'){
		//取消关注
		$.post("<?php echo U('Esxz/esxz_collect');?>",{
			  'id':<?php echo ($goods_detail["goods_id"]); ?>,
			  'type':2
			  },
			  function( data ){
			  	 console.log(data);
...
//企业
$(".es_detil_q").mouseover(function(){
	$(".es_detil_mi8").css("display","block");
})
$(".es_detil_q").mouseout(function(){
	$(".es_detil_mi8").css("display","none");
})
$(".es_detil_mi8").mouseover(function(){
	$(".es_detil_mi8").css("display","block");
})
$(".es_detil_mi8").mouseout(function(){
	$(".es_detil_mi8").css("display","none");
})
//量
$(".es_detil_mi32").mouseover(function(){
	$(".es_detil_mi9").css("display","block");
})
$(".es_detil_mi32").mouseout(function(){
	$(".es_detil_mi9").css("display","none");
})
$(".es_detil_mi9").mouseover(function(){
	$(".es_detil_mi9").css("display","block");
})
$(".es_detil_mi9").mouseout(function(){
	$(".es_detil_mi9").css("display","none");
})
...
$(".scqr").click(function(){
	...
	$(".zz_nr").eq(0).css("display","none");
	$(".zz_nr").eq(1).css("display","none");
  $(".zz_nr_bjzd").css("display","none");
  $(".zz_nr_bjzd2").css("display","none");
});
</script>

   	      ...
   	      <div  class="mypj2 jzfb">
             	...
             	<div class="jzfb1">
             	  <div class="jzfb11">
             		<select class="jzfb10" onchange="window.location=this.value">
             			<option>排序规则</option>
             			<option value="<?php echo U('JueZhi/JueZhi_fbgl',array('type'=>1));?>">按发布时间</option>
             			<option value="<?php echo U('JueZhi/JueZhi_fbgl',array('type'=>2));?>">按修改时间</option>
             		</select>
             	  </div>
             	  <div class="jzfb12">
              ...
              <div class="jzfb2">
	               <table class="myxy32">
		    		<tr>
		    			<td>基本信息</td>
		    			<td style="width:188px;">发布时间</td>
		    			<td  style="width:188px;">最后更新时间</td>
		    			<td>浏览量</td>
		    			<td>操作</td>
		    		</tr>
...
//二设置左边点击背景
   $(".my_t5 li a").eq(1).css("backgroundColor","white").css("color","#e40050");
  $(".my_t5 li a").eq(1).siblings().css("backgroundColor","none");

...
var IIInsomniaCityPicker = function(options){
    this.template = $('<div class="IIInsomnia-city-picker" id="IIInsomnia_city_picker"><div class="IIInsomnia-wrap"><p>选择省份</p><ul class="IIInsomnia-province-wrap" id="IIInsomnia_province_wrap"></ul></div></div>');
...
IIInsomniaCityPicker.prototype = {
    init: function(){
        ...
        that.settings.target.mouseleave(function(event) {
            /* Act on the event */
    ...
    targetEvent: function(){
        ...
        that.settings.target.mouseenter (function(event){
            event.stopPropagation();
            /* Act on the event */
            var _this = $(this);
            ...
            $('#cityChoice').append(that.template);

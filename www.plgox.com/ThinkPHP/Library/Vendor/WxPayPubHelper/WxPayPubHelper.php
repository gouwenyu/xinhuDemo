...
class Common_util_pub
{
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wx4ff19b6511cb0168';
			//受理商ID，身份标识
			$this->MCHID = '1486263132';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = '01cb589091e66a930fe5e3583c48440a';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = '4d40651a766ed1399cbf7b4090d479ac';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
			$this->SSLCERT_PATH = './cacert/apiclient_cert.pem';
			$this->SSLKEY_PATH = './cacert/apiclient_key.pem';
			//商户名称
			$this->COMPANY = '无限魄力(北京)网络科技有限公司';
